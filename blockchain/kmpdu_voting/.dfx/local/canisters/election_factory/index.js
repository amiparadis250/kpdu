...
import { idlFactory } from './election_factory.did.js';
export { idlFactory } from './election_factory.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ELECTION_FACTORY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./election_factory.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the election_factory canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./election_factory.did.js")._SERVICE>}
 */
export const election_factory = createActor(canisterId);
