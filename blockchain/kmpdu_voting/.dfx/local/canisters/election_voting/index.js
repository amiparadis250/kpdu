...
import { idlFactory } from './election_voting.did.js';
export { idlFactory } from './election_voting.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ELECTION_VOTING;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./election_voting.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the election_voting canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./election_voting.did.js")._SERVICE>}
 */
export const election_voting = createActor(canisterId);
