...
import { idlFactory } from './voting_canister.did.js';
export { idlFactory } from './voting_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VOTING_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./voting_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the voting_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./voting_canister.did.js")._SERVICE>}
 */
export const voting_canister = createActor(canisterId);
