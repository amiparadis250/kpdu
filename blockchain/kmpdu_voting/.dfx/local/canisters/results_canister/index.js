...
import { idlFactory } from './results_canister.did.js';
export { idlFactory } from './results_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_RESULTS_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./results_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the results_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./results_canister.did.js")._SERVICE>}
 */
export const results_canister = createActor(canisterId);
