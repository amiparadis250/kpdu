...
export const canisterId = process.env.CANISTER_ID_IDENTITY_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./identity_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the identity_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./identity_canister.did.js")._SERVICE>}
 */
export const identity_canister = createActor(canisterId);
